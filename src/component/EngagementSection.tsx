...
export default function EngagementSection({
  ...
  const imageUrl = data?.engagementModelImage?.url
    ? `${process.env.NEXT_PUBLIC_SERVER_URL}${data?.engagementModelImage?.url}`
    : "https://res.cloudinary.com/dsoilebvu/image/upload/v1777048316/hire_yvjiek.png";
  ...
  const cards = activeEngagements.map((engagement) => ({
    content: (
      <div>
        ...
        <h3 className="on-demand-title engangement-titel">
          {engagement.title}
        </h3>
    ...
    <>
            ...
            <div>
              <div className="section-head section-head-two sticky-header">
                ...
                <div className="title title-two">
                  <h2 className="title-h2-2 title-h2-two engagement-modal-title">
                    {data?.engagementModelTitle ||
                      "Strategic Engagement Models Designed to Scale Your Business with Confidence"}
                  </h2>
                </div>
              </div>
              ...
              <div className="relative flex justify-center overflow-hidden">
                <div className="relative aspect-square w-full max-w-[500px] sm:max-w-[500px] md:max-w-[600px] lg:h-[600px] lg:w-[700px] xl:h-[700px] xl:w-[800px]">
                  ...
                  <div className="absolute bottom-[10%] left-1/2 -translate-x-1/2">
                    <Link
                      href="/contact-us"
                      className="!flex !items-center !gap-2 !whitespace-nowrap !rounded-full !bg-black !border-2 !border-white !px-5 !py-3 !text-sm !font-semibold !text-white !transition-all hover:!bg-gray-800 hover:!border-gray-300 !shadow-lg sm:!px-7 sm:!py-3.5"
      ...
      <section className="section engagement-section lg:hidden hidden">
        <div className="container-3 engagement-container responsive-style w-container">
          ...
          <div className="engagement-content-wrap">
            <div className="engagement-list">
              {activeEngagements.map((e, i) => (
                <div
                  key={i}
                  className={`engagement-list-item ${i > 0 ? `engagement-list-item-${i + 1}` : ""}`}
                >
            ...
            <div className="engagement-image-wrap figure">
              ...
              <div className="engagement-btn-wrap">
                <Link
                  href="/contact-us"
                  className="button-primary engangement-cta w-inline-block"
                >
          ...
          <Link
            href="/contact-us"
            className="button-primary engangement-cta responsive-style w-inline-block"
          >
            <div className="text-block-16">Get in touch</div>
            <Image
              alt="arrow-top-right"
